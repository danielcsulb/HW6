...
function createCandidate() {
    ...
    cell3.innerHTML = '<button style="font-size:24px" onclick="addLike(this)">Like <i class="fa fa-thumbs-o-up"></i></button>';
    cell4.innerHTML = '<button style="font-size:24px" onclick="deleteRow(this)">Delete <i class="fa fa-eraser"></i></button>';
    document.getElementById('candidateForm').innerHTML = '<input style="font-size:24px" type="text" id="candidateInput" placeholder="Name"><button style="font-size:24px" onclick="createCandidate()">Create<i class="fa fa-user-plus"></i></button>';
